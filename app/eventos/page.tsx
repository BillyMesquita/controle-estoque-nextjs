...
const tabs = ['Ativo', 'Planejado', 'Finalizado', 'Cancelado']
              ...
              <div key={e.id} className="card">
                <div className="flex items-start justify-between mb-3">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    {e.status !== 'Cancelado' && (
                      <button onClick={() => handleCancel(e.id)} className="p-1.5 hover:bg-red-50 rounded-lg text-gray-400 hover:text-red-600"><Trash2 className="w-4 h-4" /></button>
                    )}
                  </div>
                </div>
