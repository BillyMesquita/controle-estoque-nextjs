...
export default function EventosPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      : ['Ativo', 'Planejado', 'Finalizado'].map(status => {
          ...
          return (
            <div key={status}>
              <div className="flex items-center gap-2 mb-4"><Icon className={`w-5 h-5 ${sc.color.split(' ')[0]}`} /><h2 className="text-lg font-semibold text-gray-900">{sc.label}</h2><span className="text-sm text-gray-400">({items.length})</span></div>
