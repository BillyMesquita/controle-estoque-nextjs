  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div><h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Novo Usuário</h1><p className="text-sm text-gray-500 mt-1">Cadastrar novo usuário no sistema</p></div>
      </div>
